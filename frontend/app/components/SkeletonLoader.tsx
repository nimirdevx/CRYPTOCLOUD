...
export function CardSkeleton() {
  return (
    <div className="bg-white p-6 rounded-2xl shadow-lg animate-pulse border border-gray-200">
...
export function DashboardSkeleton() {
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-white to-gray-50 p-4 md:p-10">
