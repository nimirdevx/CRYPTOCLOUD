...
export const FileUploadSection = ({
  ...
  return (
    <>
      ...
      {isDragging && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-indigo-900/90 backdrop-blur-sm animate-fade-in"
          onDragEnter={onDragEnter}
          onDragOver={onDragOver}
          onDragLeave={onDragLeave}
          onDrop={onDrop}
        >
          <div className="text-center p-12 border-4 border-dashed border-indigo-400 rounded-3xl bg-indigo-950/50 max-w-2xl mx-4 transform scale-105 transition-all">
            ...
            <p className="text-indigo-300 text-lg">
              Release to upload to {currentFolderName || "your storage"}
            </p>
          </div>
        </div>
      )}
      ...
      <div
        className="glass p-6 rounded-2xl shadow-2xl mb-8 animate-slide-up relative"
        onDragEnter={onDragEnter}
        onDragOver={onDragOver}
        onDragLeave={onDragLeave}
        onDrop={onDrop}
