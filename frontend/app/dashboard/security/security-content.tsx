...
import { User, SettingsIcon, Shield, Folder } from "lucide-react";
  ...
  return (
    <div className="flex-1 flex flex-col gap-6">
      ...
      <div className="flex-1 flex gap-4">
        <aside className="w-64 bg-[#F4F5F7]  flex flex-col overflow-hidden p-6">
          <div className="space-y-2 mb-6">
            ...
            >
              ...
              <span className="font-medium text-[1.1rem]">Account</span>
            </button>
            {/* <button
            ...
            >
              ...
              <span className="font-medium text-[1.1rem]">Settings</span>
            </button> */}
            <button
            ...
            >
              ...
              <span className="font-medium text-[1.1rem]">Security</span>
            </button>
          </div>
        ...
        <div className="flex-1 bg-white rounded-3xl shadow-sm flex flex-col overflow-hidden p-8">
          {activeTab === "account" && (
            <>
              <h2
                style={{
